...
public class Main12Activity extends AppCompatActivity {
    ...
    public void userwaterchangeright(View view) {
        databaseReference2.child(uid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (role.equals("admin")) {
                    ...
                    AlertDialog.Builder s = new AlertDialog.Builder(Main12Activity.this);
                    ...
                    s.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            if (water.equals("Available")) {
                                databaseReference.child("right").child("water").setValue("Not Available");
                            } else {
                                databaseReference.child("right").child("water").setValue("Available");
                            }
                            Calendar c=Calendar.getInstance();
                            SimpleDateFormat s=new SimpleDateFormat("HH:mm:ss");
                            String date="Last Modified at :"+s.format(c.getTime());
                            databaseReference3.child("right").child("water").setValue(date);
                            Intent i2 = new Intent(Main12Activity.this, Main5Activity.class);
                            startActivity(i2);
                        }
                    });
                    s.setNegativeButton("no", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent s1 = new Intent(Main12Activity.this, Main5Activity.class);
                            startActivity(s1);
                        }
                    ...
                    Toast.makeText(Main12Activity.this, "Sorry You dont have the proper rights to Change the values in this " + "action", Toast.LENGTH_SHORT).show();
                    Intent s1 = new Intent(Main12Activity.this, Main5Activity.class);
                    startActivity(s1);
                }
            }
    ...
    protected void onStart() {
        ...
        databaseReference3.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String date= dataSnapshot.child("right").child("water").getValue().toString();
